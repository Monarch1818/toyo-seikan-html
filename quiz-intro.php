...
<!-- ===== PRE-FOOTER ===== -->
<div class="quiz-intro-pre-footer d-flex justify-content-end align-items-center">
    <button type="button" class="quiz-intro-report-btn d-flex align-items-center justify-content-center gap-2">
        <i class="fa-solid fa-triangle-exclamation"></i> Report problem
    </button>
</div>

<!-- ===== FOOTER ===== -->
<footer class="quiz-intro-site-footer">
    <p class="quiz-intro-footer-text">สงวนลิขสิทธิ์ ฉ 2021 Toyo Seikan (Thailand) Co., Ltd.</p>
</footer>
