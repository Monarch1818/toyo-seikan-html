...
<!-- ===== PRE-FOOTER ===== -->
<div class="quiz-test-pre-footer d-flex justify-content-end align-items-center">
    <button type="button" class="quiz-test-report-btn d-flex align-items-center justify-content-center gap-2">
        <i class="fa-solid fa-triangle-exclamation"></i> Report problem
    </button>
</div>

<!-- ===== FOOTER ===== -->
<footer class="quiz-test-site-footer">
    <p class="quiz-test-footer-text">สงวนลิขสิทธิ์ ฉ 2021 Toyo Seikan (Thailand) Co., Ltd.</p>
</footer>
